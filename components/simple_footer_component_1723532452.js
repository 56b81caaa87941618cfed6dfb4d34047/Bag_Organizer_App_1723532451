...
*/
Vue.component("simple_footer_component_1723532452", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            BagTrak - Your Luggage Companion
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        BagTrak makes keeping track of your bags easy. Stay organized and never lose a bag again with our innovative tracking solution.
                    </div>
                </div>
            </div>
        </footer> 
